...
CREATE TABLE `haltes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_halte` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `kendaraans` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `kendaraans_no_plat_unique` (`no_plat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  `jenis` enum('info','promo','akun') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('customer','driver') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2024_12_01_120023_create_kendaraans_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_12_01_120108_create_haltes_table',1);
